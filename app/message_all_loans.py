...
with Session.begin() as session:
    ...
    for loan in loans:
        ...
        data = {'user': f'{settings.box_uganda_username}', 'password': f'{settings.box_uganda_password}',
                'sender': 'sambax',
                'message': f'Hello {user.first_name}, Your loan balance with Sambax Finance is UgX{loan.loan_balance}.Your loan expires on {loan.expiry_date} .You are advised to make payment today to clear the loan. Thank you',
